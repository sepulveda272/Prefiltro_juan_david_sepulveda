import PerfilLipidico from '../models/PerfilLipidico.js'
...
export const getPerfilLipidicos = async(req,res)=>{
...
export const postPerfilLipidico = async(req, res ) => {
...
export const deletePerfilLipidico = async (req, res)=>{
    const {id} = req.params
...
export const updatePerfilLipidico = async(req, res)=>{
    const {id} = req.params;
