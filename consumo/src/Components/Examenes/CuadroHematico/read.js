            ...
            <div id="informacion">
                <div id="tabla1">
                    <div id="botones-grandes">
                        <a href="./cuadro.html"><button style={{backgroundColor: "#FF7777"}} id="naranja">Cuadro Hematico</button></a>
                        <a href="../glisemia/glisemia.html"><button id="gris">Glisemia</button></a>
